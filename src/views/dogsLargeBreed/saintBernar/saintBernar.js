...
import {  getAllSaintBernard } from "../../../services/breeds.js";
import { auth } from "../../../config/firebaseInit.js";
import { doc, deleteDoc } from "firebase/firestore";
import { db } from "../../../config/firebaseInit.js";

export default async function saintBernardView() {
    const saintBernard = await getAllSaintBernard();
    render(saintBernardTemplate(saintBernard), mainEl);
}

function saintBernardTemplate(saintBernard) {
    ...
    return html`
        <section class="chihuahua-info">
            ...
            ${saintBernard.length === 0
            ? html`<p class="no-data">Няма налични Санбернари за осиновяване в момента. </p>`
            : saintBernard.map(
                (breed) => html`
